            ...
            <div class="navbar-brand-wrapper d-flex justify-content-center">
                <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                    <a class="navbar-brand brand-logo" href="dashboard.aspx">
                        <img src="images/believe-02.png" alt="logo" /></a>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false"
                            ...
                            <span class="menu-title">Sales Elements</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="AddClient.aspx">Add New Client</a>
                                </li>

                                <li class="nav-item"><a class="nav-link" href="ViewAreas.aspx">View Projects</a>
                                </li>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-xl-6 grid-margin stretch-card flex-column">
                            ...
                            <div class="row" runat="server" id="stagesCou">
                        ...
                        <div class="col-xl-6 grid-margin stretch-card flex-column">
                            ...
                            <div class="row h-100">
                                <div class="col-md-12 stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-start flex-wrap" runat="server" id="ClientCount">
                         ...
                         <div class="row">
                                <div class="col-xl-6 grid-margin stretch-card flex-column">
                            <h5 class="mb-2 text-titlecase mb-4">Your Tools</h5>
                            <div class="row">
                             <div class="col-md-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <p class="mb-0 text-muted">My Clients</p>
                                                <p class="mb-0 text-muted">+1.37%</p>
                                            </div>
                                            <h4>1352</h4>
                                            <canvas id="MClient-chart" class="mt-auto" height="65"></canvas>
                                        </div>
                                    </div>
                                </div>
                             <div class="col-md-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <p class="mb-0 text-muted">My Following</p>
                                                <p class="mb-0 text-muted">+1.37%</p>
                                            </div>
                                            <h4>1352</h4>
                                            <canvas id="Mfollowing-chart" class="mt-auto" height="65"></canvas>
                                        </div>
                                    </div>
                                </div>
                             <div class="col-md-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <p class="mb-0 text-muted">Open Cases </p>
                                                <p class="mb-0 text-muted">+1.37%</p>
                                            </div>
                                            <h4>1352</h4>
                                            <canvas id="OCases-chart" class="mt-auto" height="65"></canvas>
                                        </div>
                                    </div>
                                </div>
                              <div class="col-md-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <p class="mb-0 text-muted">My Meetings</p>
                                                <p class="mb-0 text-muted">+1.37%</p>
                                            </div>
                                            <h4>1352</h4>
                                            <canvas id="MMeetings-chart" class="mt-auto" height="65"></canvas>
                                        </div>
                                    </div>
                                </div>
                              ...
                              <div class="col-xl-6 grid-margin stretch-card flex-column">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="card">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <p class="mb-0 text-muted">Pipeline</p>
                                                <p class="mb-0 text-muted">+1.37%</p>
                                            </div>
                                            <h4>1352</h4>
                              ...
                              <div class="col-md-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <p class="mb-0 text-muted">Late Following</p>
                                                <p class="mb-0 text-muted">+1.37%</p>
                                            </div>
                                            <h4>1352</h4>
                                            <canvas id="LFollowing-chart" class="mt-auto" height="65"></canvas>
                                        </div>
                                    </div>
                                </div>
                              <div class="col-md-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <p class="mb-0 text-muted">My Customers</p>
                                                <p class="mb-0 text-muted">+1.37%</p>
                                            </div>
                                            <h4>1352</h4>
                                            <canvas id="MCustomers" class="mt-auto" height="65"></canvas>
                                        </div>
                                    </div>
                                </div>
                              <div class="col-md-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <p class="mb-0 text-muted">Not interested</p>
                                                <p class="mb-0 text-muted">+1.37%</p>
                                            </div>
                                            <h4>1352</h4>
                                            <canvas id="Notinterested-chart" class="mt-auto" height="65"></canvas>
                                        </div>
                                    </div>
                                </div>
                                      </div>
                                ...
                                <div class="col-md-6 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                <p class="mb-0 text-muted">Not important</p>
                                                <p class="mb-0 text-muted">+1.37%</p>
                                            </div>
                                            <h4>1352</h4>
                                            <canvas id="Notimportant-chart" class="mt-auto" height="65"></canvas>
                                        </div>
                                    </div>
                                </div>
                             </div>
               ...
               <li class="nav-item ml-0">
                    ...
                    <li class="nav-item">
                           ...
                           <asp:ListItem class="dropdown-item" Value="C">C</asp:ListItem>
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-responsive  table-bordered table-hover"
                                                Font-Overline="False" ItemStyle-HorizontalAlign="Center" AutoGenerateColumns="False"
                                                DataKeyNames="ClientID" DataSourceID="EntityDataSource2" 
                    ...
                    DataNavigateUrlFormatString="ClientDetails.aspx?ID={0}" />
                                            ...
                                            <asp:EntityDataSource runat="server" ID="EntityDataSource2" DefaultContainerName="db_a7b2aa_accorrEntities"
                                                ...
                                                EnableInsert="True" EnableUpdate="True" EntitySetName="Clients"></asp:EntityDataSource>
                                           </form>  
                        ...
                        <div class="card-body">
                            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                                ...
                                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center text-muted">
                                    Free <a href="https://www.bootstrapdash.com/" class="text-muted" target="_blank">Bootstrap
